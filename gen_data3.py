...
# Load update_table3.py code to get current data
with open(r'k:\1\Preparation_of_Papers_for_IEEE_ACCESS\update_table3.py', 'r', encoding='utf-8') as f:
    orig_code = f.read()
...
# Parse test4.tex to get start_prices
start_prices = {}
with open(r'k:\1\Preparation_of_Papers_for_IEEE_ACCESS\test4.tex', 'r', encoding='utf-8') as f:
    lines = f.readlines()
...
if start_idx != -1 and end_idx != -1:
    ...
    with open(r'k:\1\Preparation_of_Papers_for_IEEE_ACCESS\update_table3.py', 'w', encoding='utf-8') as f:
        f.write(new_code)
    print("update_table3.py successfully rewritten with new balanced preds.")
else:
    print("Could not find boundaries for data dict in update_table3.py")
