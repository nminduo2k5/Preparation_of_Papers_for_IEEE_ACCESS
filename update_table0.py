...
data = {'CMG_Ensemble_Long': {'actual': [41.9, 35.1, 35.2, 35.2], 'pred': [42.88, 35.52, 31.21, 39.41]},
 ...
 'HPG_Ensemble_Long': {'actual': [26.7, 26.25, 26.7, 26.7], 'pred': [28.1, 25.11, 28.03, 27.33]},
 'HPG_Ensemble_Medium': {'actual': [30.35, 26.9, 26.75, 26.3], 'pred': [28.0, 29.01, 27.2, 27.0]},
 'HPG_Ensemble_Short': {'actual': [29.85, 28.0, 26.4, 26.4], 'pred': [28.29, 28.6, 28.02, 27.61]},
 ...
 'HPG_RoundRobin_Long': {'actual': [26.7, 26.25, 26.7, 26.7], 'pred': [26.41, 25.11, 28.03, 27.33]},
...
process_file(r'k:\1\Preparation_of_Papers_for_IEEE_ACCESS\test6.tex')
