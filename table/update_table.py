...
data = {
    ...
    # HPG - Hierarchical
    'HPG_Hierarchical_Short': {'pred': [24.28, 28.21, 26.18, 26.83], 'actual': [29.85, 28, 26.4, 26.4]},
    ...
    # HPG - Round Robin
    'HPG_RoundRobin_Short': {'pred': [27.89, 29.15, 27.12, 27.55], 'actual': [29.85, 28, 26.4, 26.4]},
    ...
    # HPG - Ensemble
    'HPG_Ensemble_Short': {'pred': [25, 25.73, 26.98, 26.77], 'actual': [29.85, 28, 26.4, 26.4]}, 
    ...
    'TCB_Hierarchical_Medium': {'pred': [38.81, 39.06, 36.03, 36.51], 'actual': [39, 35.7, 35, 34.1]},
    'TCB_Hierarchical_Long': {'pred': [39.61, 33, 31.19, 32.02], 'actual': [35.1, 32, 33.6, 33.6]},
    
    # TCB - Round Robin
    'TCB_RoundRobin_Short': {'pred': [37.63, 40.08, 36.42, 36.86], 'actual': [39.6, 40.65, 36.1, 36.1]},
    'TCB_RoundRobin_Medium': {'pred': [34.36, 36.06, 32.25, 32.97], 'actual': [39, 35.7, 35, 34.1]},
    'TCB_RoundRobin_Long': {'pred': [30.86, 33, 30.12, 30.4], 'actual': [35.1, 32, 33.6, 33.6]},
    
    # TCB - Ensemble
    'TCB_Ensemble_Short': {'pred': [37.5, 39.97, 36.54, 36.27], 'actual': [39.6, 40.65, 36.1, 36.1]}, 
    'TCB_Ensemble_Medium': {'pred': [33.8, 35.62, 32.74, 30.57], 'actual': [39, 35.7, 35, 34.1]},
    'TCB_Ensemble_Long': {'pred': [34.87, 32.72, 33.24, 33.25], 'actual': [35.1, 32, 33.6, 33.6]},
    
    
    # VHM - Hierarchical
    'VHM_Hierarchical_Short': {'pred': [104.82, 122.43, 111.57, 113.43], 'actual': [102.3, 116, 114.5, 114.5]},
    'VHM_Hierarchical_Medium': {'pred': [106.01, 104.02, 104.04, 105.02], 'actual': [104.5, 104, 100.2, 99.6]},
    'VHM_Hierarchical_Long': {'pred': [111.13, 100.87, 105, 101.9], 'actual': [99.2, 93.9, 101.5, 101.5]},
    
    # VHM - Round Robin
    'VHM_RoundRobin_Short': {'pred': [105.13, 122.73, 114.27, 113.68], 'actual': [102.3, 116, 114.5, 114.5]},
    'VHM_RoundRobin_Medium': {'pred': [107.47, 105.47, 101.05, 106.21], 'actual': [104.5, 104, 100.2, 99.6]},
    'VHM_RoundRobin_Long': {'pred': [107.83, 101.56, 105.05, 107.41], 'actual': [99.2, 93.9, 101.5, 101.5]},
    
    # VHM - Ensemble
    'VHM_Ensemble_Short': {'pred': [100.22, 116.89, 116.18, 114.07], 'actual': [102.3, 116, 114.5, 114.5]},
    'VHM_Ensemble_Medium': {'pred': [105.98, 104.92, 103.54, 91.78], 'actual': [104.5, 104, 100.2, 99.6]},
    ...
    # MWG - Ensemble
    'MWG_Ensemble_Short': {'pred': [71.76, 87.77, 86.12, 81], 'actual': [77.5, 84.5, 85.7, 85.7]},
    ...
    'CMG_Hierarchical_Long': {'pred': [34.09, 34, 32.58, 32.59], 'actual': [41.9, 35.1 , 35.2, 35.2]},
    ...
    # CMG - Ensemble
    'CMG_Ensemble_Short': {'pred': [40.23, 39.99, 38.53, 38], 'actual': [41.85, 37.3, 38.75, 38.75]},
    ...
    # DGC - Hierarchical
    'DGC_Hierarchical_Short': {'pred': [96.52, 93.01, 86.68, 88], 'actual': [99.3, 93.2, 92.4, 92.4]},
...
process_file(r'k:\1\Preparation_of_Papers_for_IEEE_ACCESS\table\test1.tex')

print("Successfully processed test1.tex")
